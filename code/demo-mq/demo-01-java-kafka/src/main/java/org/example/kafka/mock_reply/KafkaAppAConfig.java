package org.example.kafka.mock_reply;
...
//    @Bean("orderReplyingKafkaTemplate")
//    public ReplyingKafkaTemplate<String, String, String> replyingKafkaTemplate(ProducerFactory<String, String> pf,
//            @Qualifier("orderReplyContainer") ConcurrentMessageListenerContainer<String, String> replyContainer) {
//
