...
/**
 * 读文件（有界流 by DataStream）
 */
public class Demo00_02_WordCountBatch_DataStream {
    private static final Logger LOGGER = LoggerFactory.getLogger(Demo00_02_WordCountBatch_DataStream.class);
    ...
    public void test() {
        ...
        DataStreamSource<String> dataStreamSource = executionEnvironment.readTextFile("data/word.txt");
