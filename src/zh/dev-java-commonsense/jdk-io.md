...
> + [CSDN|说好不能打脸|架构设计：系统间通信（8）——通信管理与RMI上篇](https://blog.csdn.net/yinwenjie/article/details/49120813)
> + [CSDN|说好不能打脸|架构设计：系统间通信（9）——通信管理与RMI下篇](https://blog.csdn.net/yinwenjie/article/details/49338263)
> + [CSDN|说好不能打脸|架构设计：系统间通信（10）——RPC的基本概念](https://blog.csdn.net/yinwenjie/article/details/49453303)
> + [CSDN|说好不能打脸|架构设计：系统间通信（11）——RPC实例ApacheThrift上篇](https://yinwj.blog.csdn.net/article/details/49620623)
> + [CSDN|说好不能打脸|架构设计：系统间通信（12）——RPC实例ApacheThrift中篇](https://yinwj.blog.csdn.net/article/details/49685763)
> + [CSDN|说好不能打脸|架构设计：系统间通信（13）——RPC实例ApacheThrift下篇（1）](https://yinwj.blog.csdn.net/article/details/49869535)
> + [CSDN|说好不能打脸|架构设计：系统间通信（14）——RPC实例ApacheThrift下篇（2）](https://yinwj.blog.csdn.net/article/details/49976237)
> + [CSDN|说好不能打脸|架构设计：系统间通信（15）——服务治理与Dubbo上篇](https://yinwj.blog.csdn.net/article/details/50113139)
> + [CSDN|说好不能打脸|架构设计：系统间通信（16）——服务治理与Dubbo中篇（预热）](https://yinwj.blog.csdn.net/article/details/50193987)
> + [CSDN|说好不能打脸|架构设计：系统间通信（17）——服务治理与Dubbo中篇（分析）](https://yinwj.blog.csdn.net/article/details/50277289)
> + [CSDN|说好不能打脸|架构设计：系统间通信（18）——服务治理与Dubbo下篇（继续分析）](https://yinwj.blog.csdn.net/article/details/50377914)
> + [CSDN|说好不能打脸|架构设计：系统间通信（19）——MQ：消息协议（上）](https://yinwj.blog.csdn.net/article/details/50698695)
> + [CSDN|说好不能打脸|架构设计：系统间通信（20）——MQ：消息协议（下）](https://yinwj.blog.csdn.net/article/details/50820369)
> + [CSDN|说好不能打脸|架构设计：系统间通信（21）——ActiveMQ的安装与使用](https://yinwj.blog.csdn.net/article/details/50916518)
> + [CSDN|说好不能打脸|架构设计：系统间通信（22）——提高ActiveMQ工作性能（上）](https://yinwj.blog.csdn.net/article/details/50955502)
> + [CSDN|说好不能打脸|架构设计：系统间通信（23）——提高ActiveMQ工作性能（中）](https://yinwj.blog.csdn.net/article/details/50991443)
> + [CSDN|说好不能打脸|架构设计：系统间通信（24）——提高ActiveMQ工作性能（下）](https://yinwj.blog.csdn.net/article/details/51064242)
> + [CSDN|说好不能打脸|架构设计：系统间通信（25）——ActiveMQ集群方案（上）](https://yinwj.blog.csdn.net/article/details/51124749)
> + [CSDN|说好不能打脸|架构设计：系统间通信（26）——ActiveMQ集群方案（下）](https://yinwj.blog.csdn.net/article/details/51205822)
> + [CSDN|说好不能打脸|架构设计：系统间通信（27）——其他消息中间件及场景应用（上）](https://yinwj.blog.csdn.net/article/details/51247935)
> + [CSDN|说好不能打脸|架构设计：系统间通信（28）——Kafka及场景应用（中1）](https://yinwj.blog.csdn.net/article/details/51280672)
> + [CSDN|说好不能打脸|架构设计：系统间通信（29）——Kafka及场景应用（中2）](https://yinwj.blog.csdn.net/article/details/51298296)
> + [CSDN|说好不能打脸|架构设计：系统间通信（30）——Kafka及场景应用（中3）](https://yinwj.blog.csdn.net/article/details/51336165)
> + [CSDN|说好不能打脸|架构设计：系统间通信（31）——其他消息中间件及场景应用（下1）](https://yinwj.blog.csdn.net/article/details/51354773)
> + [CSDN|说好不能打脸|架构设计：系统间通信（32）——其他消息中间件及场景应用（下2）](https://yinwj.blog.csdn.net/article/details/51459120)
> + [CSDN|说好不能打脸|架构设计：系统间通信（33）——其他消息中间件及场景应用（下3）](https://yinwj.blog.csdn.net/article/details/51516329)
> + ~~[CSDN|说好不能打脸|架构设计：系统间通信（34）——被神化的ESB（上）](https://yinwj.blog.csdn.net/article/details/51577512)~~
> + ~~[CSDN|说好不能打脸|架构设计：系统间通信（35）——被神化的ESB（下）](https://yinwj.blog.csdn.net/article/details/51602613)~~
> + [CSDN|说好不能打脸|架构设计：系统间通信（36）——ApacheCamel快速入门（上）](https://yinwj.blog.csdn.net/article/details/51692340)
> + [CSDN|说好不能打脸|架构设计：系统间通信（37）——ApacheCamel快速入门（中）](https://yinwj.blog.csdn.net/article/details/51725807)
> + [CSDN|说好不能打脸|架构设计：系统间通信（38）——ApacheCamel快速入门（下1）](https://yinwj.blog.csdn.net/article/details/51769820)
> + [CSDN|说好不能打脸|架构设计：系统间通信（39）——ApacheCamel快速入门（下2）](https://yinwj.blog.csdn.net/article/details/51818352)
> + [CSDN|说好不能打脸|架构设计：系统间通信（40）——自己动手设计ESB（1）](https://yinwj.blog.csdn.net/article/details/51931090)
> + [CSDN|说好不能打脸|架构设计：系统间通信（41）——自己动手设计ESB（2）](https://yinwj.blog.csdn.net/article/details/51986430)
> + [CSDN|说好不能打脸|架构设计：系统间通信（42）——自己动手设计ESB（3）](https://yinwj.blog.csdn.net/article/details/52039587)
> + [CSDN|说好不能打脸|架构设计：系统间通信（43）——自己动手设计ESB（4）](https://yinwj.blog.csdn.net/article/details/52056796)
> + [CSDN|说好不能打脸|架构设计：系统间通信（44）——自己动手设计ESB（5）](https://yinwj.blog.csdn.net/article/details/52141093)
> + [CSDN|说好不能打脸|架构设计：系统间通信（45）——阶段性问题记录](https://yinwj.blog.csdn.net/article/details/52186254)
