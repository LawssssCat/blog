...
live2d_settings['aboutPageUrl']         = 'http://www.baidu.com';   // 关于页地址, '{URL 网址}' ,例如 'https://www.fghrsh.net/post/123.html'(来源-大佬博客)
...
function showMessage(text, timeout, flag) {
    if(flag 
       || sessionStorage.getItem('waifu-text') === ''  //没有文字缓存缓存
       || sessionStorage.getItem('waifu-text') === null){
        ...
        if (timeout === undefined) timeout = 5000;//没定义时间,显示5s
        hideMessage(timeout);
    }
}
