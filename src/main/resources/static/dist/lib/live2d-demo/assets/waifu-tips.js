...
//看板娘样式设置
live2d_settings['waifuSize']            = '360x300';    // 看板娘大小，例如 '280x250'(默认), '600x535'
live2d_settings['waifuTipsSize']        = '260x100';     // 提示框大小，例如 '250x70'(默认), '570x150'
...
function showMessage(text, timeout, flag) {
    ...
    || sessionStorage.getItem('waifu-text') === null)
    {
        ...
        $('.waifu-tips').html(text).fadeTo(200, 1);//显示tips板,内容为text
...
function hideMessage(timeout) {
    ...
    if (timeout === undefined) timeout = 5000;//没设时间,默认5s
    $('.waifu-tips').delay(timeout).fadeTo(200, 0 , function() {
